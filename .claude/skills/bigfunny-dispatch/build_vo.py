...
EDGE_VOICE = "en-US-AvaMultilingualNeural"; EDGE_RATE = "-3%"
...
PHRASES = [
    ("Every summer,", 0),
    ("Alaska has to count its caribou.", 0),
    ("On the North Slope,", 1),
    ("one herd can run into the tens of thousands.", 1),
    ("Biologists fly the tundra", 2),
    ("and bring back thousands of aerial photos.", 2),
    ("Then a person has to find", 3),
    ("every animal in every frame.", 3),
    ("A new model from Microsoft's AI for Good lab", 4),
    ("learns each caribou from a single dot,", 4),
    ("not a boxed outline.", 4),
    ("Those dots are up to seven times faster", 5),
    ("and three times cheaper to draw.", 5),
    ("On Alaska's 2022 Central Arctic survey,", 6),
    ("its count landed within about three percent of the herd.", 6),
    ("But the model has a limit.", 7),
    ("Where the animals crowd together,", 7),
    ("its count starts to slip.", 7),
    ("It counts what the camera sees.", 8),
    ("It cannot fly the plane, or find the herd.", 8),
    ("So the plane still flies, the model counts,", 9),
    ("and the number comes home sooner.", 9),
]
